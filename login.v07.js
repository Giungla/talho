(function () {
  ...
  function validateUserField () {
    ...
    toggleClass(userFieldWrapper, ERROR_MESSAGE_CLASS, !isFieldValid && userField.value.length > 0)
  ...
  function validatePassField () {
    ...
    toggleClass(passFieldWrapper, ERROR_MESSAGE_CLASS, !isFieldValid)
  ...
  attachEvent(userField, 'input', function () {
    removeClass(userFieldWrapper, ERROR_MESSAGE_CLASS)
  }, false)

  attachEvent(passField, 'blur', validatePassField, false)
  attachEvent(passField, 'input', function () {
    removeClass(passFieldWrapper, ERROR_MESSAGE_CLASS)
  }, false)

  attachEvent(loginForm, 'change', function () {
    addClass(parentNode, 'w-form')
  }, { once: true })
  ...
  attachEvent(loginForm, 'submit', async (e) => {
    ...
    addClass(generalErrorMessage, GENERAL_HIDDEN_CLASS)
    ...
    changeErrorMessage(response.data?.message)
    removeClass(generalErrorMessage, GENERAL_HIDDEN_CLASS)
